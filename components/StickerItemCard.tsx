...
export const StickerItemCard: React.FC<StickerItemCardProps> = ({ item, index, isDragMode, dragListeners, onUpdate }) => {
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-3">
        <div className="text-sm md:text-base font-cormorant italic tracking-widest text-[#9F97A8]">
