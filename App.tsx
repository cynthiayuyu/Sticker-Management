  ...
  return (
    <div className="min-h-screen pb-24 border-t-4 border-[#7D7489]">
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-6 mt-12">
        {/* Filter Section - 篩選器區域 */}
        <div className="mb-8 space-y-6">
          {/* Filters Row - 手機垂直，電腦水平 */}
          <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6 pb-6 border-b border-[#F3F0EB]">
            {/* Status Filter */}
            <div className="flex items-center gap-3">
              <span className="text-[10px] font-cormorant uppercase tracking-[0.2em] text-[#D8D2CB] whitespace-nowrap">狀態</span>
            ...
            <div className="h-px md:h-4 md:w-px bg-[#E5E0D8]"></div>

            {/* Type Filter */}
            <div className="flex items-center gap-3">
              <span className="text-[10px] font-cormorant uppercase tracking-[0.2em] text-[#D8D2CB] whitespace-nowrap">類型</span>
              <div className="flex gap-2">
                {[
                  ...
                  <button
                    ...
                    className={`px-2.5 py-1 rounded-full text-[10px] font-fangsong tracking-wider transition-all border whitespace-nowrap ${
                      filterType === type.value
                        ? 'bg-[#7D7489] text-white border-[#7D7489] shadow-md'
            ...
            {/* Series Filter */}
            <div className="flex items-center gap-3">
              <span className="text-[10px] font-cormorant uppercase tracking-[0.2em] text-[#D8D2CB] whitespace-nowrap">系列</span>
              <select
                value={filterSeries}
                onChange={(e) => setFilterSeries(e.target.value)}
                className="bg-transparent border-b border-[#E5E0D8] text-xs md:text-sm font-fangsong py-1 focus:outline-none focus:border-[#7D7489] text-[#7D7489] cursor-pointer"
              >
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex flex-col gap-2 min-h-[40px]">
              {isCompressing && compressionProgress && (
                <div className="flex flex-col gap-1">
                  ...
                  <div className="w-full max-w-xs h-1 bg-[#F3F0EB] rounded-full overflow-hidden">
                    <div
            ...
            <div className="flex flex-col md:flex-row gap-4 md:items-center">
              ...
              {/* Backup & Compression */}
              <div className="flex flex-wrap items-center gap-2 pb-3 md:pb-0 md:pr-4 md:border-r border-b md:border-b-0 border-[#F3F0EB]">
                <Button
                  onClick={handleCompressAll}
                  variant="ghost"
                  size="sm"
                  className="text-[10px] md:text-xs text-[#9F97A8] hover:text-[#7D7489] disabled:opacity-50"
                  disabled={isCompressing}
                >
                  {isCompressing ? '壓縮中...' : '一鍵壓縮'}
                </Button>
                <Button onClick={handleExport} variant="ghost" size="sm" className="text-[10px] md:text-xs text-[#9F97A8] hover:text-[#7D7489]">
                  匯出
                </Button>
                ...
                {isLoggedIn ? (
                  <>
                    <Button
                      ...
                      variant="ghost"
                      size="sm"
                      className="text-[10px] md:text-xs text-[#9F97A8] hover:text-[#7D7489] disabled:opacity-50 flex items-center gap-1"
                      disabled={isSyncing}
                    >
                    ...
                    <Button
                      ...
                      variant="ghost"
                      size="sm"
                      className="text-[10px] text-[#D8D2CB] hover:text-[#9F97A8]"
                    >
                      登出
                    </Button>
                  </>
                  ...
                  <>
                    <Button
                      ...
                      variant="ghost"
                      size="sm"
                      className="text-[10px] md:text-xs text-[#9F97A8] hover:text-[#7D7489] flex items-center gap-1"
                    >
                      <svg width="10" height="10" viewBox="0 0 15 15" fill="none">
